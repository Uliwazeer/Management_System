...
// global variables
char adminPassword[MAX_LENGTH] = "Wazeer";  // login password for ADMINISTRATOR
...
void infoScreen()
{
    ...
    printf("\t\t\t\t------------------------------------ \n\n");
    printf("\t\t\t\t\t > Ali Wazeer \n");
    printf("\t\t\t\t\t > Hussieny Wazeer \n");
    printf("\t\t\t\t\t > Mostafa Wazeer \n");
    printf("\t\t\t\t\t > Cheahan Wazeer \n");
    printf("\t\t\t\t\t > Nour Wazeer \n");
    printf("\t\t\t\t\t > Rabaa Wazeer \n\n");
    printf("\t\t\t\t------------------------------------ \n\n");
    system("pause");
...
void endScreen()
{
    ...
    printf("\t\t\t\tLinkedIn: https://linkedin.com/in/Aliwazeer \n\n");
    printf("\t\t\t\t------------------------------------------ \n");
    printf("\t\t\t\t\t\tThank You. \n");
    printf("\t\t\t\t------------------------------------------ \n\n");
...
void updateContact()
{
    ...
    printf("----------------------------- \n\n");
    printf("Enter the phone number to update [+20]: ");
    gets(findNumber);
    printf("\n");
